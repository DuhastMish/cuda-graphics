...
int main()
{
	...
	unsigned char* data = stbi_load("../textures/yelow.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	data = stbi_load("../textures/hurt.png", &width, &height, &nrChannels, 0);
	if (data)
	{
